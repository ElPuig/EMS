# -*- coding: utf-8 -*-
{
   ...
   'data': [
        ...
        'views/academic_management/menu.xml',
            ...
            'views/academic_management/enrollment/authorization_search.xml',
            'views/academic_management/enrollment/authorization_view.xml',
            'views/academic_management/enrollment/authorization_form.xml',
