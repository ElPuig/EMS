...
- A family with several children can link a contact it adds to the other children too, and the form points out (and asks about) a contact of another of its children with the same DNI/NIE or mobile, so the same person is not entered twice. Only contacts of the family's own children are ever pointed out.
