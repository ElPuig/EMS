...
5. Si els fitxers esmenten un correu de docent que EMS no ha trobat, una pantalla de **Resoldre docents** en llista cadascun: tria el docent real al desplegable (un error/desajust d'un docent ja existent), o bé, si el correu pertany realment a un docent que mai no ha estat contractat, marca **Nou** en lloc d'això — això bloqueja el desplegable (no es poden fer les dues coses alhora) i crea un nou docent pendent d'identificació per a aquest correu al pas final d'Importar, de la mateixa manera que un codi de lloc encara no cobert (vegeu "Docents encara no contractats" més avall), amb la diferència que es conserva el correu del fitxer, precarregat com a **Correu de treball** editable a mà (**Assignar correu corporatiu manualment** marcat) en lloc de generar-se automàticament, ja que encara no s'ha confirmat. Si tots els correus s'han reconegut, veuràs un missatge de confirmació. El botó **Continua** també apareix atenuat aquí fins que totes les files tenen un docent triat o **Nou** marcat.
