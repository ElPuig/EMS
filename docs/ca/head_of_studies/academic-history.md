[Català](academic-history.md) | [Castellano](../../es/head_of_studies/academic-history.md) | [English](../../en/head_of_studies/academic-history.md)

---

# Històric acadèmic: consultes de cohort
...
A més, a la fitxa de qualsevol alumne/a, la secció **Històric acadèmic**, al final de la pestanya **Estudis**, mostra els seus registres — també per a l'**antic alumnat** (graduats/des i baixes), per als quals la pestanya Estudis només mostra aquesta secció, com a registre permanent.

## Consultes útils

- **Agrupar per curs + estudi:** resultats de cada cohort, any a any.
- **Filtres de resultat acadèmic:** *Superat íntegrament*, *Superat parcialment*, *Repeteix curs*, *Baixa* — p. ex. quants alumnes d'un estudi van repetir en un curs determinat.
- **Títol obtingut:** tot l'alumnat que va obtenir el títol en un curs.
- **Finals pendents d'estada:** mòduls aprovats amb la nota final a l'espera de l'estada (EM) — la llista de treball de les estades pendents d'avaluar.

## Com llegir les notes
