...
5. Canvia a la vista de **gràfic** (icones a dalt a la dreta) per veure un resum visual — per defecte mostra el **% d'absentisme per assignatura** de tot el centre, així pots detectar d'un cop d'ull quines assignatures tenen més absentisme.
