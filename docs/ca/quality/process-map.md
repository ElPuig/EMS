[Català](process-map.md) | [Castellano](../../es/quality/process-map.md) | [English](../../en/quality/process-map.md)

---

# Mapa de processos

**Qualitat → Documentació → Mapa de processos** mostra el mapa de processos del centre, el document de Google on hi ha
...
1. Feu clic a **Qualitat**: el mapa de processos és la primera pantalla que s'obre. El document es
   mostra dins de la pantalla.
...
El mapa és un document més de **Qualitat → Documentació → Documents**, marcat com a mapa de processos.
