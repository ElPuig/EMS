...
- **En una baixa:** l'assistent de baixa congela l'històric de l'alumne/a **en aquell moment**, abans de desvincular-lo del seu grup. Qui deixa el centre a mig curs conserva el registre de tot el que va fer fins aquell dia (mòduls, notes, assistència), amb el resultat **Baixa**.
