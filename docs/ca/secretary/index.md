...
- [Enviar autoritzacions durant el curs](authorizations.md) — Crear una autorització que apareix amb el curs començat, enviar-la a l'alumnat que correspongui i fer el seguiment de les respostes.
