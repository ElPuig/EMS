...
| [Photo visibility](employees/photo_visibility.md) | Teacher-controlled photo visibility (all / teachers / directive staff), the `res.users`/`hr.employee` field split and why `image_1920` becomes derived |
