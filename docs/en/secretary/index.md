...
- [Convalidations: registering and following up requests](../head_of_studies/convalidations.md) — Registering a convalidation request received on paper and following up the ones the Head of Studies resolves (shared manual with the Head of Studies).
