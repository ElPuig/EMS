...
> Unlike the 3 PDF reports below, this screen isn't scoped to only the groups/subjects you teach — it
> shows whatever attendance data you have read access to, same as other teacher-facing attendance screens.
