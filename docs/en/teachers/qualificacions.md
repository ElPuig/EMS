[Català](../../ca/teachers/qualificacions.md) | [Castellano](../../es/teachers/qualificacions.md) | [English](qualificacions.md)
...
![Grade session list grouped by round and group](../../assets/teachers/teachers-01-llista-sessions.png)
...
![Overview of the grading grid](../../assets/teachers/teachers-02-graella.png)
...
![Editing an outcome cell in the grid](../../assets/teachers/teachers-03-edicio-cel-la.png)
...
![Outcome locked with the padlock for passed in an earlier round](../../assets/teachers/teachers-04-ra-bloquejat.png)
...
![Apply changes button with pending changes](../../assets/teachers/teachers-06-aplicar-canvis.png)
...
![Grade session state in the header](../../assets/teachers/teachers-07-estat.png)
...
## Students with a convalidated subject

When the secretariat completes the convalidation of a subject you teach, you get a **Convalidated subject** activity in your inbox (🕒), on the student's form, with the grade and the convalidation's registration number. From then on the student no longer takes the subject: they leave your attendance lists and the open grade session, even if you had already graded them. Rounds already closed keep them, with the grade followed by **CV**.
