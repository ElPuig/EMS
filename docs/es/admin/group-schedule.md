...
Debajo de la rejilla, una tabla **Asignatura → Docente(s)** lista cada asignatura impartida
a ese grupo y quién la imparte. Cuando una asignatura se da en codocencia (más de un
profesor a la vez), todos los nombres aparecen juntos en la fila de esa asignatura — la
