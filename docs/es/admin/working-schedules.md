...
6. Haz clic en **Continuar** en las pantallas restantes (todavía no construidas como pantallas propias — una versión futura permitirá resolver aquí mismo los conflictos de aula, en lugar de solo en el paso final).
7. En el paso final, haz clic en **Importar**. Este es el momento en que todo se escribe de verdad, y donde cualquier problema pendiente (un aula que falta, un conflicto de horario) se reporta indicando exactamente qué hay que corregir.
