[Català](../../ca/families/manual-documentacio.md) | [Castellano](manual-documentacio.md) | [English](../../en/families/manual-documentacio.md)

---

# Subir documentos oficiales, IBAN y solicitudes de beneficios

Esta guía explica cómo enviar documentos oficiales (DNI/pasaporte, tarjeta sanitaria), registrar tu cuenta bancaria (IBAN) y solicitar una bonificación o exención de cuota, desde la página **Documentación** del portal del alumno.

---

## Contenido

1. [Dónde se suben los documentos](#dónde-se-suben-los-documentos)
2. [Subir un DNI, pasaporte o tarjeta sanitaria](#subir-un-dni-pasaporte-o-tarjeta-sanitaria)
3. [Registrar o renovar tu IBAN](#registrar-o-renovar-tu-iban)
4. [Solicitar una bonificación o exención](#solicitar-una-bonificación-o-exención)
5. [Consultar el estado de una tramitación](#consultar-el-estado-de-una-tramitación)
...
Cada tramitación muestra uno de estos cuatro estados:

- **Pendiente de revisión** — a la espera de que el centro la compruebe.
