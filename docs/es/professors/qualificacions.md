[Català](../../ca/professors/qualificacions.md) | [Castellano](qualificacions.md) | [English](../../en/professors/qualificacions.md)
...
![Lista de sesiones de evaluación agrupada por evaluación y grupo](../../assets/professors/professors-01-llista-sessions.png)
...
![Vista general de la cuadrícula de calificaciones](../../assets/professors/professors-02-graella.png)
...
![Edición de una celda de RA en la cuadrícula](../../assets/professors/professors-03-edicio-cel-la.png)
...
![RA bloqueado con el candado de aprobado en una evaluación anterior](../../assets/professors/professors-04-ra-bloquejat.png)
...
![Columnas de nota del módulo: Empresa, Sobrescribir centro, Centro, Final y Comentarios](../../assets/professors/professors-05-columnes-nota.png)
...
![Botón Aplicar los cambios con cambios pendientes](../../assets/professors/professors-06-aplicar-canvis.png)
...
![Estado de la sesión de evaluación en la cabecera](../../assets/professors/professors-07-estat.png)
