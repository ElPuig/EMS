...
- [Convalidaciones: registrar y hacer el seguimiento de las solicitudes](../head_of_studies/convalidations.md) — Registrar una solicitud de convalidación recibida en papel y hacer el seguimiento de las que resuelve Jefatura de Estudios (manual compartido con Jefatura de Estudios).
