...
2. El campo **Grupos** se rellena automáticamente con todos los grupos donde impartes esa asignatura, y **Tutores** muestra sus tutores como referencia. Si solo quieres algunos de esos grupos en el informe, quita el resto del campo **Grupos** — se queda editable.
