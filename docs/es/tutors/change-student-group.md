[Català](../../ca/tutors/change-student-group.md) | [Castellano](change-student-group.md) | [English](../../en/tutors/change-student-group.md)

---

# Cambiar el grupo de un alumno

A veces un alumno debe cambiar de grupo (por ejemplo, del grupo A al grupo B) dentro del mismo estudio. Como tutor/a, puedes hacerlo tú mismo/a desde la propia ficha del alumno.

**Rol necesario:** Tutor

---

## Cómo cambiar el grupo de un alumno
...
**Si el cambio es rechazado:** significa que alguna asignatura del grupo antiguo ya tiene notas registradas para este alumno. Contacta con administración para resolverlo antes de mover al alumno.
