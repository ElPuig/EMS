...
class ems_criteria(models.Model):
	_name = "ems.criteria"		
	...
	outcome_id = fields.Many2one(string='Learning Outcome', comodel_name='ems.outcome', compute='_compute_outcome', store=True)
	...
	# criteria_ids = fields.One2many(string="Composite", comodel_name="ems.criteria", inverse_name="criteria_id")
	# criteria_id = fields.Many2one(string="Parent", comodel_name="ems.criteria")
