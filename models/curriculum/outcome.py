...
class ems_outcome(models.Model):
	_name = 'ems.outcome'
	...
	# outcome_ids = fields.One2many(string="Composite", comodel_name="ems.outcome", inverse_name="outcome_id")
	# outcome_id = fields.Many2one(string="Parent", comodel_name="ems.outcome")	
