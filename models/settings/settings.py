...
class ems_settings(models.TransientModel):
   ...
   # TODO: this field should be stores within company and used in the same way as attendance_issue_delay?
   ...
   attendance_issue_delay = fields.Integer(string="Attendance notification delay (in minutes)", related="company_id.attendance_issue_delay", readonly=False)