...
// The working-schedule import wizard's onchange (_onchange_file / _onchange_attachment_ids in
...
export class EmsBlockingBinaryField extends BinaryField {
    setup() {
        super.setup();
...
export const emsBlockingBinaryField = {
    ...binaryField,
    component: EmsBlockingBinaryField,
};
registry.category("fields").add("ems_blocking_binary", emsBlockingBinaryField);
